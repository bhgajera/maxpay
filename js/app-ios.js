...
.run(function($ionicPlatform,$rootScope,$ionicHistory,$state,$http,$ionicPopup,CategoryService,GetBanner,$ionicSlideBoxDelegate) {
...
.controller('MyCtrl', function($scope,CategoryService) {
            ...
            setTimeout(function(){
                  ...
                  CategoryService.getAll_Category().success(function(response){
                                                            ...
                                                            console.log("TEST ==>"+JSON.stringify($scope.groups))
